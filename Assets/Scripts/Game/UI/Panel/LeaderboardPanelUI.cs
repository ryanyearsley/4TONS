...
public class LeaderboardPanelUI : AbstractPanelUI {
	...
	protected override void InitializePanel () {
		...
		if (GameManager.instance != null) {
			...
			Zone zone = GameManager.instance.gameContext.zoneData.zone;
			leaderboardName = GameManager.instance.gameContext.objectiveData.objectiveName + ": " + zone.ToString ();
		}
	...
	protected override void OnUIChange (GameState gameState) {
		if (panelActiveStates.Contains (gameState)) {
			...
			if (PlayFabManager.instance != null) {
				PlayFabManager.instance.GetLeaderboard (leaderboardName, UpdateLeaderboardSuccess, UpdateLeaderboardFail);
			}
		} else {
