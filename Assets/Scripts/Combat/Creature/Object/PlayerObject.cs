...
public class PlayerObject : CreatureObject {
	...
	[SerializeField]
	private PrebuildWizardData defaultWizardSaveData;
	...
	public void ReusePlayerObject (Player player) {
		...
		if (player.wizardSaveData.spellSchoolData != null) {
			...
			player.wizardSaveData = defaultWizardSaveData.wizardSaveData;
			wizardGameData = WizardGameDataMapper.MapWizardSaveToGameData (defaultWizardSaveData.wizardSaveData);
		}
